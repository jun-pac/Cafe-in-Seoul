...
- "우천 접근성"은 **지하철역과 지하통로로 직결돼 비를 안 맞고 갈 수 있다**는 뜻이다. "비 오는 날 작업하기 좋다"는 의미가 절대 아니다. 해당하면 "지하철과 지하로 연결돼 비 오는 날도 안 젖고 갈 수 있다"처럼 접근성으로만 서술하고, 아니면 언급하지 마라.
...
아이스아메리카노: ${cafe.iced_americano_price}원
우천 접근성(지하철과 지하통로로 직결돼 비 안 맞고 도달): ${cafe.rain_ok ? '예' : '아니오'}
